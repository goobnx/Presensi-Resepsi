...
$ambiltamu = mysqli_query($koneksi, "SELECT * FROM tamu WHERE kehadiran='Tidak Hadir' ORDER BY status DESC");
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <thead>
                                    ...
                                    <tbody>
                                        <?php
                                        while ($p = mysqli_fetch_array($ambiltamu)) {
                                            $id_tamu = $p['id_tamu'];
                                        ...
                                        <tr data-id="<?= $id_tamu; ?>">
                                            ...
                                            <td>
                                                <?php 
                                                    if ($status == 'VIP') {
                                                        echo "<button class='btn btn-success'><a href='proses_presensi.php?id=" . $id_tamu . "' style='color: inherit; text-decoration: none;'>Hadir</a></button>";
                                                    } else {
                                                        echo "<button class='btn btn-warning'><a href='proses_presensi.php?id=" . $id_tamu . "' style='color: inherit; text-decoration: none;'>Hadir</a></button>";
                                                    }
                                                ?>
                                            </td>
                                        </tr>
