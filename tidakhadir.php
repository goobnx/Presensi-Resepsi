...
$hitungtamu2 = mysqli_query($koneksi, "SELECT * FROM tamu WHERE kehadiran='Tidak Hadir'");
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Daftar Tamu Belum Hadir</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                    <?php
                                    while ($p = mysqli_fetch_array($hitungtamu2)) {
                                        $id_tamu = $p['id_tamu'];
